...
def extract_education(text: str) -> List[EducationItem]:
    ...
    # Split text and find education section
    sections = re.split(education_keywords, text, flags=re.IGNORECASE)
    if len(sections) > 1:
        education_text = sections[-1][:1000]  # Limit to reasonable section size
    else:
        education_text = text
...
def extract_experience(text: str) -> List[ExperienceItem]:
    ...
    # Split text and find experience section
...
def extract_projects(text: str) -> List[ProjectItem]:
    ...
    # Split text and find projects section
    ...
    # Pattern: Project Title, Technologies, Description
    project_patterns = [
    ...
    for pattern in project_patterns:
        ...
        for match in matches:
            try:
                ...
                # Extract technologies from tech string
...
def extract_certifications(text: str) -> List[str]:
    ...
    # Keywords that indicate certifications section
    cert_keywords = r'(certification|certifications|license|licenses|credential|aws|azure|gcp)'
    
    # Split text and find certifications section
